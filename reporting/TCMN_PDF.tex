...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in init\_Params(): could not find function "{}.getCountryCode"{}}}\end{kframe}
%%%%%%%%%%%%%%%% PAGE 1 %%%%%%%%%%%%%%%%%%%
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in match.arg(method): object 'Subsection' not found}}\end{kframe}
%    }
%'   \end{minipage}  
...
%'       \centering
%'       \resizebox{\textwidth}{!}{
%'     <<test,echo=FALSE,message=FALSE,cache=FALSE,warning=FALSE,fig.align='center',results="asis">>=  
%'       
%'       #source("TCMN_charts.R")
%'       
%'       #macroInd_Big(cou)
%'       
%'       @      
...
%'       \centering
%'       \resizebox{\textwidth}{!}{%
%'     <<ImpExp_Treemap-1,echo=FALSE,message=FALSE,cache=FALSE,warning=FALSE,fig.align='center',fig.height=2.5,fig.width=8,results="asis">>=  
%'       
%'       #source("TCMN_charts.R")
%'       
...
%'       \centering
%'       \resizebox{\textwidth}{!}{%
%'     <<ImpExp_Treemap-2,echo=FALSE,message=FALSE,cache=FALSE,warning=FALSE,fig.align='center',fig.height=1.6,fig.width=8,results="asis">>=  
%'       
%'       #source("TCMN_charts.R")
%'       
...
%'   \hspace*{-0.4cm}\raggedleft{\color{white!40!black} \footnotesize TRADE AND COMPETITIVENESS MONITORING NOTE - UPDATED month year}
%' \end{minipage}
%' 
%' \newpage
%' %%%%%%%%%%%%%%%% PAGE 2 %%%%%%%%%%%%%%%%%%%
...
%'   \vspace*{-0.4cm}
%'   \raggedleft{\color{white!40!black} \footnotesize TRADE AND COMPETITIVENESS MONITORING NOTE - UPDATED month year}
%' \end{minipage}

...
\begin{minipage}[t]{0.99\textwidth} % top section
  ...
  \begin{minipage}[c]{0.36\textwidth} 
    \begin{minipage}[c]{0.28\textwidth} % flag
      \includegraphics[width=1.2cm,height=1.2cm]{www/tn.png}
    \end{minipage}
...
\begin{tabular}{>{\centering}p{1.5in}>{\centering}p{1.5in}>{\centering}p{1.5in}>{\centering}p{1.5in}>{\centering}p{1.5in}>{\centering}p{1.5in}l}
  GDP (US\$ billions) (2016) & Population (millions) (2016) & Income per capita (current US\$) (2016) & Poverty rate (2010) & Unemployment rate (2016) & Ease of Doing Business Rank (2016) &  \\ 
     44 &    11 & 3,883 &     2 &    14 &    74 &  \\ 
  \end{tabular}
}
...
GDP growth (annual \%) &   4.03 &   2.52 &   2.30 &   0.80 &   2.80 &   3.70 &  \\ 
  ...
  Cash surplus/deficit (\% of GDP) &  -2.61 &  -5.93 &   1.07 &   0.75 &   2.45 &   3.55 &  \\ 
  Gross Fixed Investment (\% GDP) &  23.61 &  19.55 &  20.42 &  19.35 &  19.23 &  19.44 &  \\ 
  Gross capital formation (\% of GDP) \large{[1]} &  24.09 &  22.30 &  21.95 & --- & --- & --- &  \\ 
  Foreign direct investment, net inflows (\% of GDP) \large{[2]} &   3.95 &   2.38 &   2.19 & --- & --- & --- &  \\ 
  Private capital flows, total (\% of GDP) \large{[2]} &  17.06 & --- & --- & --- & --- & --- &  \\ 
  ...
  Personal remittances, received (\% of GDP) \large{[1]} &   4.54 &   4.88 &   4.83 & --- & --- & --- &  \\ 
  General government gross debt \large{[3]} &  50.03 &  44.27 &  50.03 &  53.96 &  56.33 & --- &  \\ 
  Total reserves in months of imports \large{[1]} &   4.12 &   3.16 &   3.13 & --- & --- & --- &  \\ 

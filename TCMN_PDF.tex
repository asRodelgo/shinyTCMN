...
GDP growth (annual \%) &   1.65 &  -1.23 &   1.39 &   3.00 &   2.70 &   1.90 &  \\ 
  ...
  Cash surplus/deficit (\% of GDP) &  -3.92 &  -7.33 &  -6.10 &  -4.86 &  -2.97 &  -2.05 &  \\ 
  Gross Fixed Investment (\% GDP) &  25.90 &  19.88 &  20.30 &  21.33 &  22.32 &  22.39 &  \\ 
  Gross capital formation (\% of GDP) \large{[1]} &  26.91 &  19.14 &  19.78 & --- & --- & --- &  \\ 
  Foreign direct investment, net inflows (\% of GDP) \large{[2]} &   2.88 &   3.00 &   1.63 & --- & --- & --- &  \\ 
  Private capital flows, total (\% of GDP) \large{[2]} &  10.97 & --- & --- & --- & --- & --- &  \\ 
  ...
  Personal remittances, received (\% of GDP) \large{[1]} &   0.28 &   0.22 &   0.23 & --- & --- & --- &  \\ 
  General government gross debt \large{[3]} &  51.51 &  92.09 &  97.67 &  98.60 &  98.81 & --- &  \\ 
  Total reserves in months of imports \large{[1]} &   0.69 &   1.21 &   1.25 & --- & --- & --- &  \\ 
...
\begin{minipage}[b]{0.99\textwidth}
  \vspace{0.8cm}
   \begin{minipage}[c]{0.44\textwidth} 
    %\vspace*{-0.2cm}
    \begin{minipage}[t]{0.99\textwidth} 
      {\color{blue!50!black} \textbf{\small Top 5 Exports by \% of Total Value,}} 
      % expYear}}
      %\vspace{3ex}
      \\[6pt]
      \centering
...
{\centering \includegraphics[width=\maxwidth]{figure/ImpExp_Treemap-1-1} 
      ...
      \\[14pt]
      \begin{minipage}[t]{0.99\textwidth} 
      {\color{blue!50!black} \textbf{\small Imports Categories by \% of Total Value,}}
      %impYear}}
      \\[6pt]
      \centering
      \resizebox{\textwidth}{!}{%

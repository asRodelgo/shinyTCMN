...
\begin{figure}
  ...
  \includegraphics[width=5cm]{www/wb_logo_background.png}
\end{figure}
\begin{figure}
  \begin{minipage}[t]{0.99\textwidth} % top section
      \vspace{-30ex}
      \hspace{-2ex}
      \raggedright{\includegraphics[width=5.5cm,right]{www/TCMN_banner3.png}}
...
\begin{minipage}[t]{0.99\textwidth} % top section
  ...
  \begin{minipage}[c]{0.36\textwidth} 
    \begin{minipage}[c]{0.28\textwidth} % flag
      \includegraphics[width=1.2cm,height=1.2cm]{www/dz.png}
    \end{minipage}
...
GDP growth (annual \%) &   3.73 &   2.81 &   4.30 &   2.80 &   3.90 &   4.00 &  \\ 
  ...
  Cash surplus/deficit (\% of GDP) &   4.39 &  -0.78 &  -5.89 & -11.52 &  -9.40 &  -6.43 &  \\ 
  Gross Fixed Investment (\% GDP) &  23.94 &  34.23 &  35.07 &  35.18 &  35.54 &  36.26 &  \\ 
  Gross capital formation (\% of GDP) \large{[1]} &  35.75 &  43.38 &  45.61 & --- & --- & --- &  \\ 
  Foreign direct investment, net inflows (\% of GDP) \large{[2]} &   1.41 &   1.27 &   0.70 & --- & --- & --- &  \\ 
  Private capital flows, total (\% of GDP) \large{[2]} &   4.85 & --- & --- & --- & --- & --- &  \\ 
  ...
  Personal remittances, received (\% of GDP) \large{[1]} &   0.75 &   0.10 &   0.14 & --- & --- & --- &  \\ 
  General government gross debt \large{[3]} &  23.21 &   8.28 &   8.79 &  10.19 &  13.59 & --- &  \\ 
  Total reserves in months of imports \large{[1]} &  32.51 &  32.80 & --- & --- & --- & --- &  \\ 
...
\begin{minipage}[c]{0.33\textwidth}
  \hspace*{+0.3cm} \includegraphics[width=4cm,left]{www/wb_logo.jpg}

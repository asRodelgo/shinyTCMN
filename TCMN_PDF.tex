...
%   %\includegraphics[width=5cm]{images/wb_logo_background.png}
% \end{figure}
% \begin{figure}
%   %\begin{minipage}[t]{0.99\textwidth} % top section
%       \vspace{-30ex}
%       \hspace{-2ex}
%       %\raggedright{\includegraphics[width=5.5cm,right]{images/TCMN_banner3.png}}
...
\begin{minipage}[t]{0.99\textwidth} % top section
  ...
  \begin{minipage}[c]{0.36\textwidth} 
    \begin{minipage}[c]{0.28\textwidth} % flag
      %\includegraphics[width=1.2cm,height=1.2cm]{www/couISO2.png}
    \end{minipage}
    \begin{minipage}[c]{0.70\textwidth} % Country name
      %\section*{\color{blue!40!black}couName}
    \end{minipage}
  \end{minipage}
...
% Sun Jan  3 07:41:58 2016
{\LARGE
\begin{tabular}{>{\centering}p{1.5in}>{\centering}p{1.5in}>{\centering}p{1.5in}>{\centering}p{1.5in}>{\centering}p{1.5in}l}
  GDP (US\$ billions) (2016) & Population (millions) (2016) & Income per capita (current US\$) (2016) & Unemployment rate (2016) & Ease of Doing Business Rank (2016) &  \\ 
     203 &     10 & 19,513 &     11 &     23 &  \\ 
  \end{tabular}
}
...
\begin{tabular}{lr>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}>{\raggedleft}p{0.8in}l}
  ...
  \hline
GDP growth (annual \%) &   0.139 &  -1.605 &   0.903 &   1.600 &   1.800 &   1.900 &  \\ 
  Current account balance &  -8.856 &   0.510 &   0.287 &  -0.248 &  -0.027 &   0.155 &  \\ 
  Cash surplus/deficit (\% of GDP) &  -6.667 &  -7.325 &  -6.579 &  -5.510 &  -5.240 &  -5.095 &  \\ 
  Gross Fixed Investment (\% GDP) &  22.218 &  15.179 &  15.432 &  16.431 &  17.022 &  17.761 &  \\ 
  Gross capital formation (\% of GDP) \large{[1]} &  22.139 &  14.632 &  15.144 & --- & --- & --- &  \\ 
  Foreign direct investment, net inflows (\% of GDP) \large{[2]} &   2.262 &   0.983 &   3.795 & --- & --- & --- &  \\ 
  Private capital flows, total (\% of GDP) \large{[2]} &  12.687 & --- & --- & --- & --- & --- &  \\ 
  Total Trade in Goods and Services (\% of GDP, real terms) &  66.798 &  79.709 &  82.847 &  84.628 &  86.375 &  88.223 &  \\ 
  Trade balance (\% GDP, real terms) &  -7.816 &   0.201 &  -0.978 &  -0.988 &  -0.845 &  -0.678 &  \\ 
  Exports, Goods and Services, annual percent change (real terms) &   3.558 &   6.404 &   3.376 &   3.800 &   4.100 &   4.300 &  \\ 
  Imports, Goods and Services, annual percent change (real terms) &   0.949 &   3.903 &   6.382 &   3.771 &   3.707 &   3.863 &  \\ 
  Personal remittances, received (\% of GDP) \large{[1]} &   0.689 &   0.197 &   0.184 & --- & --- & --- &  \\ 
  General government gross debt \large{[3]} &  76.641 & 129.664 & 130.190 & 127.796 & 125.006 & --- &  \\ 
  Total reserves in months of imports \large{[1]} &   1.708 &   2.073 &   2.241 & --- & --- & --- &  \\ 
  Real Effective Exchange Rate (2010=100) &  99.956 &  98.860 &  99.205 &  95.348 &  95.201 &  95.144 &  \\ 
  Consumer Price Index, annual percent change &   2.580 &   0.259 &  -0.266 &   2.219 &   1.225 &   0.731 &  \\ 
  \end{tabular}
}
...
\begin{minipage}[c]{0.99\textwidth}
  \hspace*{-0.4cm}\raggedleft{\color{white!40!black} \footnotesize TRADE AND COMPETITIVENESS MONITORING NOTE - UPDATED 01 2016}
\end{minipage}
...
\begin{minipage}[c]{0.33\textwidth}
  %\hspace*{+0.3cm} \includegraphics[width=4cm,left]{images/wb_logo.jpg}
  \hspace*{+0.3cm} \includegraphics[width=4cm,left]{www/wb_logo.png}
\end{minipage}
\begin{minipage}[c]{0.65\textwidth}
  \vspace*{-0.4cm}
  \raggedleft{\color{white!40!black} \footnotesize TRADE AND COMPETITIVENESS MONITORING NOTE - UPDATED 01 2016}
\end{minipage}

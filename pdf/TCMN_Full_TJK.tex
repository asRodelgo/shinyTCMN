...
\begin{tabular}{l>{\raggedright}p{1in}ll>{\raggedright}p{1in}>{\raggedright}p{1in}rl}
 Project ID & Project Name & Approval Date & Status & Major Sector & Major Theme & Amount (in US\$ K) &  \\ 
  \hline
P153547 & Tajikistan Tax Efiling Impact Evaluation & 2016-06-30 & Active & Public Administration, Law, and Justice & Public sector governance & --- &  \\ 
  \end{tabular}
}
...
\begin{tabular}{>{\raggedright}p{1.4in}>{\raggedright}p{1in}>{\raggedright}p{1in}>{\raggedright}p{1in}l>{\raggedright}p{1.5in}l}
 Name & Job title & Location & Role & Project ID & Project name &  \\ 
  \hline
Abdykalykov, Emil & Private Sector Development Specialist & BISHKEK, KYRGYZ REPUBLIC & Team Member & P153547 & Tajikistan Tax Efiling Impact Evaluation &  \\ 
  Goicoechea, Ana & Senior Private Sector Development Specialist & WASHINGTON, DC & Team Member & P153547 & Tajikistan Tax Efiling Impact Evaluation &  \\ 
  Isaev, Alisher & Associate Operations Officer & DUSHANBE, TAJIKISTAN & Team Member & P153547 & Tajikistan Tax Efiling Impact Evaluation &  \\ 
  Pyatachenko, Dmitry & Associate Operations Officer & MINSK, BELARUS & Team Member & P153547 & Tajikistan Tax Efiling Impact Evaluation &  \\ 
  \end{tabular}
}

...
\begin{tabular}{l>{\raggedright}p{1in}ll>{\raggedright}p{1in}>{\raggedright}p{1in}rl}
 Project ID & Project Name & Approval Date & Status & Major Sector & Major Theme & Amount (in US\$ K) &  \\ 
  \hline
P151058 & Nouadhibou Eco-Seafood Cluster Project & 2016-03-24 & Pipeline & Agriculture, fishing, and forestry & Rule of law & 7,750 &  \\ 
  \end{tabular}
}
...
\begin{tabular}{l>{\raggedright}p{1in}ll>{\raggedright}p{1in}>{\raggedright}p{1in}rl}
 Project ID & Project Name & Approval Date & Status & Major Sector & Major Theme & Amount (in US\$ K) &  \\ 
  \hline
P151421 & Diagnostic Trade Integration Study MRT & 2016-05-31 & Active & Public Administration, Law, and Justice & Economic management & --- &  \\ 
  P146554 & Nouadhibou Free Zone Support & 2015-06-29 & Closed & Agriculture, fishing, and forestry & Financial and private sector development & --- &  \\ 
  \end{tabular}
}
...
\begin{tabular}{>{\raggedright}p{1.4in}>{\raggedright}p{1in}>{\raggedright}p{1in}>{\raggedright}p{1in}l>{\raggedright}p{1.5in}l}
 Name & Job title & Location & Role & Project ID & Project name &  \\ 
  \hline
Fanta Ivanovic, Enrique & Senior Trade Facilitation Specialist & WASHINGTON, DC & Extended-Team Member & P151421 & Diagnostic Trade Integration Study MRT &  \\ 
  Hartmann, Olivier & Senior Trade Facilitation Specialist & WASHINGTON, DC & Extended-Team Member & P151421 & Diagnostic Trade Integration Study MRT &  \\ 
  Sager, Cecilia & Lead Private Sector Development Specialist & WASHINGTON, DC & Program Manager & P151058 & Nouadhibou Eco-Seafood Cluster Project &  \\ 
  Speakman, John F. & Adviser & WASHINGTON, DC & Team Leader & P146554 & Nouadhibou Free Zone Support &  \\ 
   &  &  & Program Manager & P151058 & Nouadhibou Eco-Seafood Cluster Project &  \\ 
  \end{tabular}
}

...
\begin{tabular}{l>{\raggedright}p{1in}ll>{\raggedright}p{1in}>{\raggedright}p{1in}rl}
 Project ID & Project Name & Approval Date & Status & Major Sector & Major Theme & Amount (in US\$ K) &  \\ 
  \hline
P126669 & UZ Promoting export diversification & 2013-08-23 & Closed & Industry and trade & Financial and private sector development & --- &  \\ 
  P148671 & Activity 3: MSME Dialogue & 2014-06-25 & Closed & Finance & Financial and private sector development & --- &  \\ 
  P148672 & Activity 1: Inputs to Vision 2030 Paper & 2014-06-25 & Closed & Industry and trade & Financial and private sector development & --- &  \\ 
  P148673 & Draft Background Paper for Vision 2030 & 2014-06-25 & Closed & Industry and trade & Financial and private sector development & --- &  \\ 
  \end{tabular}
}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in while (data\$Staff\_Name[j] == data\$Staff\_Name[i]) \{: missing value where TRUE/FALSE needed}}\end{kframe}
     \vspace*{0.5cm}
\end{minipage}

...
\begin{tabular}{l>{\raggedright}p{1in}ll>{\raggedright}p{1in}>{\raggedright}p{1in}rl}
 Project ID & Project Name & Approval Date & Status & Major Sector & Major Theme & Amount (in US\$ K) &  \\ 
  \hline
P153790 & BT PPP and Pvt Sector Capacity Building & 2016-05-27 & Active & Health and other social services & Financial and private sector development & --- &  \\ 
  P147082 & Bhutan Doing Business Reform TA & 2014-06-10 & Closed & Finance & Rule of law & --- &  \\ 
  \end{tabular}
}
...
\begin{tabular}{>{\raggedright}p{1.4in}>{\raggedright}p{1in}>{\raggedright}p{1in}>{\raggedright}p{1in}l>{\raggedright}p{1.5in}l}
 Name & Job title & Location & Role & Project ID & Project name &  \\ 
  \hline
Abdullah, A.K.M. & Senior Financial Sector Specialist & DHAKA, BANGLADESH & Team Leader & P153790 & BT PPP and Pvt Sector Capacity Building &  \\ 
  Santini, Massimiliano & Senior Economist & WASHINGTON, DC & Team Member & P147082 & Bhutan Doing Business Reform TA &  \\ 
  \end{tabular}
}

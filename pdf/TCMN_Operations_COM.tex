...
\begin{tabular}{>{\raggedright}p{1.4in}>{\raggedright}p{1in}>{\raggedright}p{1in}>{\raggedright}p{1in}l>{\raggedright}p{1.5in}l}
 Name & Job title & Location & Role & Project ID & Project name &  \\ 
  \hline
Dimitriyev, Steven R. & Senior Private Sector Development Specialist & MAPUTO, MOZAMBIQUE & Team Member & P147309 & Private Sector Development Policy Notes &  \\ 
   &  &  & Team Leader & P147309 & Private Sector Development Policy Notes &  \\ 

...
\begin{tabular}{l>{\raggedright}p{1in}ll>{\raggedright}p{1in}>{\raggedright}p{1in}rl}
 Project ID & Project Name & Approval Date & Status & Major Sector & Major Theme & Amount (in US\$ K) &  \\ 
  \hline
P133021 &  Value Chain Support Project & 2014-05-22 & Active & Industry and trade & Rural development & 10,200 &  \\ 
  \end{tabular}
}
...
\begin{tabular}{l>{\raggedright}p{1in}ll>{\raggedright}p{1in}>{\raggedright}p{1in}rl}
 Project ID & Project Name & Approval Date & Status & Major Sector & Major Theme & Amount (in US\$ K) &  \\ 
  \hline
P133072 & Chad Value Chain Study and Analysis & 2014-12-02 & Closed & Industry and trade & Financial and private sector development & --- &  \\ 
  \end{tabular}
}
...
\begin{tabular}{>{\raggedright}p{1.4in}>{\raggedright}p{1in}>{\raggedright}p{1in}>{\raggedright}p{1in}l>{\raggedright}p{1.5in}l}
 Name & Job title & Location & Role & Project ID & Project name &  \\ 
  \hline
Courchesne, Monique & Senior Operations Officer & WASHINGTON, DC & Team Member & P133021 &  Value Chain Support Project &  \\ 
  Hernandez Uriz, Zenaida & Senior Private Sector Development Specialist & WASHINGTON, DC & Extended-Team Member & P133021 &  Value Chain Support Project &  \\ 
  \end{tabular}
}

...
\begin{tabular}{l>{\raggedright}p{1in}ll>{\raggedright}p{1in}>{\raggedright}p{1in}rl}
 Project ID & Project Name & Approval Date & Status & Major Sector & Major Theme & Amount (in US\$ K) &  \\ 
  \hline
P153596 & BiH Development Policy Loan & 2014-10-03 & Pipeline & Industry and trade & Financial and private sector development & ---   &  \\ 
  P146740 & BiH DPL & 2014-10-03 & Closed & Industry and trade & Financial and private sector development & 50000 &  \\ 
  \end{tabular}
}
...
\begin{tabular}{l>{\raggedright}p{2.5in}llrl}
 Project ID & Project Name & Approval Date & Status & Amount (in US\$ K) &  \\ 
  \hline
600904 & Bosnia and Herzegovina Local Investment-Friendly Environment (LIFE) & 2015-10-22 & Active & 600 &  \\ 
  \end{tabular}
}

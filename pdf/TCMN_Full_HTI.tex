...
\begin{tabular}{l>{\raggedright}p{1in}ll>{\raggedright}p{1in}>{\raggedright}p{1in}rl}
 Project ID & Project Name & Approval Date & Status & Major Sector & Major Theme & Amount (in US\$ K) &  \\ 
  \hline
P128866 & HT Diagnostic Trade Integration Study & 2013-12-24 & Closed & Industry and trade & Trade and integration & --- &  \\ 
  P132421 & HT Trade Facilitation & 2015-06-27 & Closed & Industry and trade & Trade and integration & --- &  \\ 
  \end{tabular}
}
...
\begin{tabular}{>{\raggedright}p{1.4in}>{\raggedright}p{1in}>{\raggedright}p{1in}>{\raggedright}p{1in}l>{\raggedright}p{1.5in}l}
 Name & Job title & Location & Role & Project ID & Project name &  \\ 
  \hline
Fanta Ivanovic, Enrique & Senior Trade Facilitation Specialist & WASHINGTON, DC & Team Member & P132421 & HT Trade Facilitation &  \\ 
  Gillson, Ian John Douglas & Lead Operations Officer & WASHINGTON, DC & Extended-Team Member & P128866 & HT Diagnostic Trade Integration Study &  \\ 
  Hartmann, Olivier & Senior Trade Facilitation Specialist & WASHINGTON, DC & Team Member & P132421 & HT Trade Facilitation &  \\ 
  \end{tabular}
}

...
\begin{tabular}{l>{\raggedright}p{1in}ll>{\raggedright}p{1in}>{\raggedright}p{1in}rl}
 Project ID & Project Name & Approval Date & Status & Major Sector & Major Theme & Amount (in US\$ K) &  \\ 
  \hline
P149117 & Benin Cross Border Tourism \& Competitive & 2016-03-25 & Pipeline & Public Administration, Law, and Justice & Financial and private sector development & 5.e+04 &  \\ 
  \end{tabular}

...
\begin{tabular}{l>{\raggedright}p{1in}ll>{\raggedright}p{1in}>{\raggedright}p{1in}rl}
 Project ID & Project Name & Approval Date & Status & Major Sector & Major Theme & Amount (in US\$ K) &  \\ 
  \hline
P148839 & Niger Investment Climate Support & 2015-08-19 & Active & Finance & Financial and private sector development & 18,280 &  \\ 
  \end{tabular}
}
...
\begin{tabular}{l>{\raggedright}p{1in}ll>{\raggedright}p{1in}>{\raggedright}p{1in}rl}
 Project ID & Project Name & Approval Date & Status & Major Sector & Major Theme & Amount (in US\$ K) &  \\ 
  \hline
P151595 & Niger Construction Competitiveness & 2016-03-15 & Active & Energy and mining & Financial and private sector development & --- &  \\ 
  \end{tabular}
}

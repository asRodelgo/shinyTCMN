...
\begin{tabular}{l>{\raggedright}p{1in}ll>{\raggedright}p{1in}>{\raggedright}p{1in}rl}
 Project ID & Project Name & Approval Date & Status & Major Sector & Major Theme & Amount (in US\$ K) &  \\ 
  \hline
P156513 & MZ Cross Border Trade Facilitation & 2016-06-10 & Active & Public Administration, Law, and Justice & Financial and private sector development & --- &  \\ 
  P132610 & Cultural Heritage Sustainable Tourism & 2014-01-11 & Closed & Energy and mining & Financial and private sector development & --- &  \\ 
  P151818 & ZMM Growth Triangle Capacity Building & 2015-06-24 & Closed & Agriculture, fishing, and forestry & Trade and integration & --- &  \\ 
  \end{tabular}
}
...
\begin{tabular}{>{\raggedright}p{1.4in}>{\raggedright}p{1in}>{\raggedright}p{1in}>{\raggedright}p{1in}l>{\raggedright}p{1.5in}l}
 Name & Job title & Location & Role & Project ID & Project name &  \\ 
  \hline
Dimitriyev, Steven R. & Senior Private Sector Development Specialist & MAPUTO, MOZAMBIQUE & Team Leader & P151818 & ZMM Growth Triangle Capacity Building &  \\ 
   &  &  & Team Leader & P156513 & MZ Cross Border Trade Facilitation &  \\ 
  Fernandes, Eneida Herrera & Senior Private Sector Development Specialist & ANTANANARIVO, MADAGASCAR & Team Member & P132610 & Cultural Heritage Sustainable Tourism &  \\ 
   &  &  & Team Leader & P151818 & ZMM Growth Triangle Capacity Building &  \\ 
  Garrett, Keith Patrick & E T Consultant & WASHINGTON, DC & Team Member & P151818 & ZMM Growth Triangle Capacity Building &  \\ 
  \end{tabular}
}

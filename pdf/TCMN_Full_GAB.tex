...
\begin{tabular}{l>{\raggedright}p{1in}ll>{\raggedright}p{1in}>{\raggedright}p{1in}rl}
 Project ID & Project Name & Approval Date & Status & Major Sector & Major Theme & Amount (in US\$ K) &  \\ 
  \hline
P129267 & Investment Promotion and Competitiveness & 2014-03-11 & Active & Public Administration, Law, and Justice & Financial and private sector development & 18,000 &  \\ 
  \end{tabular}
}
...
\begin{tabular}{l>{\raggedright}p{1in}ll>{\raggedright}p{1in}>{\raggedright}p{1in}rl}
 Project ID & Project Name & Approval Date & Status & Major Sector & Major Theme & Amount (in US\$ K) &  \\ 
  \hline
P130700 & GA Econ Diversification RTA & 2015-03-23 & Closed & Industry and trade & Financial and private sector development & --- &  \\ 
  \end{tabular}
}
...
\begin{tabular}{>{\raggedright}p{1.4in}>{\raggedright}p{1in}>{\raggedright}p{1in}>{\raggedright}p{1in}l>{\raggedright}p{1.5in}l}
 Name & Job title & Location & Role & Project ID & Project name &  \\ 
  \hline
Courchesne, Monique & Senior Operations Officer & WASHINGTON, DC & Team Member & P129267 & Investment Promotion and Competitiveness &  \\ 
  Dem, Amadou & Senior Economist & WASHINGTON, DC & Team Leader & P129267 & Investment Promotion and Competitiveness &  \\ 
  Heilbron, Armando & Senior Investment Promotion Officer & WASHINGTON, DC & Team Member & P129267 & Investment Promotion and Competitiveness &  \\ 
  Speakman, John F. & Adviser & WASHINGTON, DC & Extended-Team Member & P129267 & Investment Promotion and Competitiveness &  \\ 
  \end{tabular}
}

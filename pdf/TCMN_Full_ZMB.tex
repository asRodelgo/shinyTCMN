...
\begin{tabular}{l>{\raggedright}p{1in}ll>{\raggedright}p{1in}>{\raggedright}p{1in}rl}
 Project ID & Project Name & Approval Date & Status & Major Sector & Major Theme & Amount (in US\$ K) &  \\ 
  \hline
P132612 & Diagnostic Trade Integration StudyZambia & 2014-07-05 & Closed & Industry and trade & Economic management & --- &  \\ 
  P145855 & ZAMBIA MINING LOCAL CONTENT PROGRAM & 2015-03-22 & Closed & Energy and mining & Financial and private sector development & --- &  \\ 
  \end{tabular}
}
...
\begin{tabular}{>{\raggedright}p{1.4in}>{\raggedright}p{1in}>{\raggedright}p{1in}>{\raggedright}p{1in}l>{\raggedright}p{1.5in}l}
 Name & Job title & Location & Role & Project ID & Project name &  \\ 
  \hline
Dihel, Nora Carina & Sr Trade Econ. & WASHINGTON, DC & Team Leader & P132612 & Diagnostic Trade Integration StudyZambia &  \\ 
  Keyser, John C. & E T Consultant & LUSAKA, ZAMBIA & Extended-Team Member & P132612 & Diagnostic Trade Integration StudyZambia &  \\ 
  Kunaka, Charles & Senior Trade Specialist & WASHINGTON, DC & Extended-Team Member & P132612 & Diagnostic Trade Integration StudyZambia &  \\ 
  Mtonya, Brian G. & Senior Private Sector Development Specialist & LUSAKA, ZAMBIA & Team Leader & P145855 & ZAMBIA MINING LOCAL CONTENT PROGRAM &  \\ 
  \end{tabular}
}

...
\begin{tabular}{l>{\raggedright}p{1in}ll>{\raggedright}p{1in}>{\raggedright}p{1in}rl}
 Project ID & Project Name & Approval Date & Status & Major Sector & Major Theme & Amount (in US\$ K) &  \\ 
  \hline
P146250 & Governance for PSD Project & 2014-06-23 & Active & Public Administration, Law, and Justice & Financial and private sector development & 2,000 &  \\ 
  \end{tabular}
}
...
\begin{tabular}{l>{\raggedright}p{1in}ll>{\raggedright}p{1in}>{\raggedright}p{1in}rl}
 Project ID & Project Name & Approval Date & Status & Major Sector & Major Theme & Amount (in US\$ K) &  \\ 
  \hline
P149727 & Djibouti Light Manufacturing report & 2014-06-28 & Closed & Industry and trade & Financial and private sector development & --- &  \\ 
  \end{tabular}
}

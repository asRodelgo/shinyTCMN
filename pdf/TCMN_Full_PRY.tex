...
\begin{tabular}{l>{\raggedright}p{1in}ll>{\raggedright}p{1in}>{\raggedright}p{1in}rl}
 Project ID & Project Name & Approval Date & Status & Major Sector & Major Theme & Amount (in US\$ K) &  \\ 
  \hline
P156168 & Support WTO Trade Facilitation Agreement & 2016-06-01 & Active & Public Administration, Law, and Justice & Public sector governance & --- &  \\ 
  P126568 & PY Inclusive Competitiveness & 2014-01-01 & Closed & Agriculture, fishing, and forestry & Financial and private sector development & --- &  \\ 
  \end{tabular}
}
...
\begin{tabular}{>{\raggedright}p{1.4in}>{\raggedright}p{1in}>{\raggedright}p{1in}>{\raggedright}p{1in}l>{\raggedright}p{1.5in}l}
 Name & Job title & Location & Role & Project ID & Project name &  \\ 
  \hline
Criscuolo, Alberto & Senior Private Sector Development Specialist & WASHINGTON, DC & Extended-Team Member & P126568 & PY Inclusive Competitiveness &  \\ 
  Fanta Ivanovic, Enrique & Senior Trade Facilitation Specialist & WASHINGTON, DC & Team Leader & P156168 & Support WTO Trade Facilitation Agreement &  \\ 
  Frias, Jaime Andres Uribe & Economist & WASHINGTON, DC & Team Member & P126568 & PY Inclusive Competitiveness &  \\ 
  Quijada Torres, Cristian & Senior Private Sector Development Specialist & WASHINGTON, DC & Extended-Team Member & P126568 & PY Inclusive Competitiveness &  \\ 
  \end{tabular}
}

...
\begin{tabular}{l>{\raggedright}p{1in}ll>{\raggedright}p{1in}>{\raggedright}p{1in}rl}
 Project ID & Project Name & Approval Date & Status & Major Sector & Major Theme & Amount (in US\$ K) &  \\ 
  \hline
P151198 & Improving trade and transport logistics & 2015-12-21 & Closed & Transportation & Financial and private sector development & --- &  \\ 
  \end{tabular}
}
...
\begin{tabular}{>{\raggedright}p{1.4in}>{\raggedright}p{1in}>{\raggedright}p{1in}>{\raggedright}p{1in}l>{\raggedright}p{1.5in}l}
 Name & Job title & Location & Role & Project ID & Project name &  \\ 
  \hline
Arvis, Jean Francois & Senior Transport Economist & WASHINGTON, DC & Team Member & P151198 & Improving trade and transport logistics &  \\ 
  McKenna, Jonathan Miles & E T Consultant & WASHINGTON, DC & Team Member & P151198 & Improving trade and transport logistics &  \\ 
  Taglioni, Daria & Sr Trade Econ. & WASHINGTON, DC & Team Leader & P151198 & Improving trade and transport logistics &  \\ 
  \end{tabular}
}

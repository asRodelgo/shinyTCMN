...
\begin{tabular}{>{\raggedright}p{1.4in}>{\raggedright}p{1in}>{\raggedright}p{1in}>{\raggedright}p{1in}l>{\raggedright}p{1.5in}l}
 Name & Job title & Location & Role & Project ID & Project name &  \\ 
  \hline
Campos, Francisco Moraes Leitao & Senior Economist & WASHINGTON, DC & Team Member & P127209 & Priv Sec Rehab \& Agribusines Dev-PSRAD &  \\ 
   &  &  & Team Leader & P127209 & Priv Sec Rehab \& Agribusines Dev-PSRAD &  \\ 

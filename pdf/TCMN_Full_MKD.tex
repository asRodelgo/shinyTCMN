...
\begin{tabular}{l>{\raggedright}p{1in}ll>{\raggedright}p{1in}>{\raggedright}p{1in}rl}
 Project ID & Project Name & Approval Date & Status & Major Sector & Major Theme & Amount (in US\$ K) &  \\ 
  \hline
P154263 & Local and Regional Competitiveness & 2016-01-12 & Active & Industry and trade & Financial and private sector development & 19,360 &  \\ 
  P130847 & MK Competitiveness DPL 2 & 2014-03-13 & Closed & Industry and trade & Financial and private sector development & 50,000 &  \\ 
  \end{tabular}
}
...
\begin{tabular}{>{\raggedright}p{1.4in}>{\raggedright}p{1in}>{\raggedright}p{1in}>{\raggedright}p{1in}l>{\raggedright}p{1.5in}l}
 Name & Job title & Location & Role & Project ID & Project name &  \\ 
  \hline
Goddard, John Gabriel & Lead Economist & PRETORIA, SOUTH AFRICA & Team Leader & P130847 & MK Competitiveness DPL 2 &  \\ 
   &  &  & Team Member & P154263 & Local and Regional Competitiveness &  \\ 
  Konar-Leacy, Violane & Operations Officer & BELGRADE, SERBIA & Team Member & P130847 & MK Competitiveness DPL 2 &  \\ 
  Saslavsky, Daniel Mario & Trade Specialist & WASHINGTON, DC & Extended-Team Member & P130847 & MK Competitiveness DPL 2 &  \\ 
  \end{tabular}
}

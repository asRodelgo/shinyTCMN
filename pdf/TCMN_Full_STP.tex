...
\begin{tabular}{l>{\raggedright}p{1in}ll>{\raggedright}p{1in}>{\raggedright}p{1in}rl}
 Project ID & Project Name & Approval Date & Status & Major Sector & Major Theme & Amount (in US\$ K) &  \\ 
  \hline
P132018 & STP Diagnostic Trade Integration Study & 2014-07-05 & Closed & Public Administration, Law, and Justice & Economic management & --- &  \\ 
  \end{tabular}
}
...
\begin{tabular}{>{\raggedright}p{1.4in}>{\raggedright}p{1in}>{\raggedright}p{1in}>{\raggedright}p{1in}l>{\raggedright}p{1.5in}l}
 Name & Job title & Location & Role & Project ID & Project name &  \\ 
  \hline
Dihel, Nora Carina & Sr Trade Econ. & WASHINGTON, DC & Team Member & P132018 & STP Diagnostic Trade Integration Study &  \\ 
  Kunaka, Charles & Senior Trade Specialist & WASHINGTON, DC & Team Member & P132018 & STP Diagnostic Trade Integration Study &  \\ 
  \end{tabular}
}

...
\begin{tabular}{l>{\raggedright}p{1in}ll>{\raggedright}p{1in}>{\raggedright}p{1in}rl}
 Project ID & Project Name & Approval Date & Status & Major Sector & Major Theme & Amount (in US\$ K) &  \\ 
  \hline
P143887 & SME Masterplan Implementation Support & 2015-06-02 & Closed & Public Administration, Law, and Justice & Financial and private sector development & --- &  \\ 
  \end{tabular}
}
...
\begin{tabular}{>{\raggedright}p{1.4in}>{\raggedright}p{1in}>{\raggedright}p{1in}>{\raggedright}p{1in}l>{\raggedright}p{1.5in}l}
 Name & Job title & Location & Role & Project ID & Project name &  \\ 
  \hline
De Magalhaes, Numa F. & Senior Private Sector Development Specialist & WASHINGTON, DC & Extended-Team Member & P143887 & SME Masterplan Implementation Support &  \\ 
  Hill, Justin Piers William & Senior Private Sector Development Specialist & WASHINGTON, DC & Extended-Team Member & P143887 & SME Masterplan Implementation Support &  \\ 
  Kuriakose, Smita & Senior Economist & WASHINGTON, DC & Team Leader & P143887 & SME Masterplan Implementation Support &  \\ 
  Lee, Une J. & Senior Private Sector Development Specialist & WASHINGTON, DC & Extended-Team Member & P143887 & SME Masterplan Implementation Support &  \\ 
  Wille, John R. & Lead Private Sector Development Specialist & WASHINGTON, DC & Extended-Team Member & P143887 & SME Masterplan Implementation Support &  \\ 
  \end{tabular}
}

...
\begin{tabular}{l>{\raggedright}p{1in}ll>{\raggedright}p{1in}>{\raggedright}p{1in}rl}
 Project ID & Project Name & Approval Date & Status & Major Sector & Major Theme & Amount (in US\$ K) &  \\ 
  \hline
P155216 & Second Knowledge Economy & 2015-12-15 & Pipeline & Industry and trade & Financial and private sector development & --- &  \\ 
  \end{tabular}
}
...
\begin{tabular}{l>{\raggedright}p{1in}ll>{\raggedright}p{1in}>{\raggedright}p{1in}rl}
 Project ID & Project Name & Approval Date & Status & Major Sector & Major Theme & Amount (in US\$ K) &  \\ 
  \hline
P131824 & RAS-MAP-Competition Council & 2015-06-15 & Closed & Public Administration, Law, and Justice & Financial and private sector development & --- &  \\ 
  P150017 & RAS Strengthening Regulatory Impact Asse & 2015-12-31 & Closed & Public Administration, Law, and Justice & Public sector governance & --- &  \\ 
  P155786 & Romania: Competitiveness & 2015-06-29 & Closed & Public Administration, Law, and Justice & Economic management & --- &  \\ 
  \end{tabular}
}
...
\begin{tabular}{>{\raggedright}p{1.4in}>{\raggedright}p{1in}>{\raggedright}p{1in}>{\raggedright}p{1in}l>{\raggedright}p{1.5in}l}
 Name & Job title & Location & Role & Project ID & Project name &  \\ 
  \hline
Andres Amo, Pedro & Senior Private Sector Development Specialist & PANAMA CITY, PANAMA & Team Member & P150017 & RAS Strengthening Regulatory Impact Asse &  \\ 
  Begazo Gomez, Tania Priscilla & Senior Economist & NAIROBI, KENYA & Extended-Team Member & P131824 & RAS-MAP-Competition Council &  \\ 
  Correa, Paulo Guilherme & Lead Economist & WASHINGTON, DC & Extended-Team Member & P131824 & RAS-MAP-Competition Council &  \\ 
  Hernandez Uriz, Zenaida & Senior Private Sector Development Specialist & WASHINGTON, DC & Extended-Team Member & P150017 & RAS Strengthening Regulatory Impact Asse &  \\ 
  Martinez Licetti, Martha & Senior Economist & WASHINGTON, DC & Team Member & P131824 & RAS-MAP-Competition Council &  \\ 
  Marusic, Andreja & Senior Operations Officer & WASHINGTON, DC & Team Member & P150017 & RAS Strengthening Regulatory Impact Asse &  \\ 
  Miralles Murciego, Graciela & Economist & WASHINGTON, DC & Extended-Team Member & P131824 & RAS-MAP-Competition Council &  \\ 
  Pop, Georgiana & Senior Economist & WASHINGTON, DC & Team Member & P131824 & RAS-MAP-Competition Council &  \\ 
  \end{tabular}
}

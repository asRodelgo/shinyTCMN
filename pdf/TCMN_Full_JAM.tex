...
\begin{tabular}{l>{\raggedright}p{1in}ll>{\raggedright}p{1in}>{\raggedright}p{1in}rl}
 Project ID & Project Name & Approval Date & Status & Major Sector & Major Theme & Amount (in US\$ K) &  \\ 
  \hline
P147665 & JM Foundations for Compet \& Growth & 2014-07-25 & Active & Industry and trade & Financial and private sector development & 50,000 &  \\ 
  \end{tabular}
}
...
\begin{tabular}{l>{\raggedright}p{1in}ll>{\raggedright}p{1in}>{\raggedright}p{1in}rl}
 Project ID & Project Name & Approval Date & Status & Major Sector & Major Theme & Amount (in US\$ K) &  \\ 
  \hline
P149316 & Jamaica JIT: Trade as Driver for Growth & 2016-03-31 & Active & Industry and trade & Trade and integration & --- &  \\ 
  \end{tabular}
}
...
\begin{tabular}{l>{\raggedright}p{2.5in}llrl}
 Project ID & Project Name & Approval Date & Status & Amount (in US\$ K) &  \\ 
  \hline
599776 & Jamaica Tax Reform Project & 2013-08-04 & Active & 1,106 &  \\ 
  \end{tabular}
}
...
\begin{tabular}{>{\raggedright}p{1.4in}>{\raggedright}p{1in}>{\raggedright}p{1in}>{\raggedright}p{1in}l>{\raggedright}p{1.5in}l}
 Name & Job title & Location & Role & Project ID & Project name &  \\ 
  \hline
Akinci, Gokhan & Lead Investment Policy Officer & WASHINGTON, DC & Extended-Team Member & P147665 & JM Foundations for Compet \& Growth &  \\ 
  Alleyne, Zahra Oluyemisi Tahirah & E T Consultant & PORT OF SPAIN, TRINIDAD \& TOBA & Team Member & P147665 & JM Foundations for Compet \& Growth &  \\ 
  Anderson, John Millies & Economist & WASHINGTON, DC & Team Member & P147665 & JM Foundations for Compet \& Growth &  \\ 
  Andres Amo, Pedro & Senior Private Sector Development Specialist & PANAMA CITY, PANAMA & Extended-Team Member & 599776 & Jamaica Tax Reform Project &  \\ 
  Astonitas Villafuerte, Lya Maine & Associate Operations Officer & WASHINGTON, DC & Extended-Team Member & 599776 & Jamaica Tax Reform Project &  \\ 
  Criscuolo, Alberto & Senior Private Sector Development Specialist & WASHINGTON, DC & Team Leader & P149316 & Jamaica JIT: Trade as Driver for Growth &  \\ 
  Dutz, Mark Andrew & Lead Economist & BRASILIA, BRAZIL & Team Member & P147665 & JM Foundations for Compet \& Growth &  \\ 
  Goodwin, Tanja K. & Private Sector Development Specialist & LIMA, PERU & Extended-Team Member & P147665 & JM Foundations for Compet \& Growth &  \\ 
  Portugal Perez, Luis Alberto & Sr Trade Econ. & WASHINGTON, DC & Team Leader & P149316 & Jamaica JIT: Trade as Driver for Growth &  \\ 
  Rubalcaba Bermejo, Luis & Senior Private Sector Development Specialist & WASHINGTON, DC & Extended-Team Member & P147665 & JM Foundations for Compet \& Growth &  \\ 
  Shahidsaless, Raha & Senior Private Sector Development Specialist & WASHINGTON, DC & Team Leader & P149316 & Jamaica JIT: Trade as Driver for Growth &  \\ 
  Tran, Trang Thu & Economist & WASHINGTON, DC & Team Member & P147665 & JM Foundations for Compet \& Growth &  \\ 
  Vis, Thomas A. & Senior Private Sector Development Specialist & WASHINGTON, DC & Team Leader & P147665 & JM Foundations for Compet \& Growth &  \\ 
  \end{tabular}
}

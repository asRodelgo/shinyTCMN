...
\begin{tabular}{l>{\raggedright}p{1in}ll>{\raggedright}p{1in}>{\raggedright}p{1in}rl}
 Project ID & Project Name & Approval Date & Status & Major Sector & Major Theme & Amount (in US\$ K) &  \\ 
  \hline
P143436 & PPP: Capacity Building & 2015-01-19 & Closed & Industry and trade & Financial and private sector development & --- &  \\ 
  P149800 & Trade Facilitation and Intervention & 2015-06-26 & Closed & Public Administration, Law, and Justice & Economic management & --- &  \\ 
  \end{tabular}
}
...
\begin{tabular}{>{\raggedright}p{1.4in}>{\raggedright}p{1in}>{\raggedright}p{1in}>{\raggedright}p{1in}l>{\raggedright}p{1.5in}l}
 Name & Job title & Location & Role & Project ID & Project name &  \\ 
  \hline
Hartmann, Olivier & Senior Trade Facilitation Specialist & WASHINGTON, DC & Team Member & P149800 & Trade Facilitation and Intervention &  \\ 
  Kunaka, Charles & Senior Trade Specialist & WASHINGTON, DC & Team Member & P149800 & Trade Facilitation and Intervention &  \\ 
  Speakman, John F. & Adviser & WASHINGTON, DC & Team Leader & P143436 & PPP: Capacity Building &  \\ 
  \end{tabular}
}

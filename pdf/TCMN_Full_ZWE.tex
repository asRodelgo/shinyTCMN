...
\begin{tabular}{l>{\raggedright}p{1in}ll>{\raggedright}p{1in}>{\raggedright}p{1in}rl}
 Project ID & Project Name & Approval Date & Status & Major Sector & Major Theme & Amount (in US\$ K) &  \\ 
  \hline
P125104 & ZW:Trade \& Trans. Facilitation Zimbabwe & 2015-01-23 & Closed & Transportation & Trade and integration & --- &  \\ 
  P126448 & Zimbabwe Small Business Survey & 2015-02-23 & Closed & Finance & Financial and private sector development & --- &  \\ 
  P144073 & ZW - Competitiveness and Trade Work & 2014-10-07 & Closed & Industry and trade & Economic management & --- &  \\ 
  \end{tabular}
}
...
\begin{tabular}{>{\raggedright}p{1.4in}>{\raggedright}p{1in}>{\raggedright}p{1in}>{\raggedright}p{1in}l>{\raggedright}p{1.5in}l}
 Name & Job title & Location & Role & Project ID & Project name &  \\ 
  \hline
Antoci, Monica Alina & Senior Private Sector Development Specialist & WASHINGTON, DC & Extended-Team Member & P125104 & ZW:Trade \& Trans. Facilitation Zimbabwe &  \\ 
  Kunaka, Charles & Senior Trade Specialist & WASHINGTON, DC & Team Member & P125104 & ZW:Trade \& Trans. Facilitation Zimbabwe &  \\ 
  Mtonya, Brian G. & Senior Private Sector Development Specialist & LUSAKA, ZAMBIA & Team Leader & P125104 & ZW:Trade \& Trans. Facilitation Zimbabwe &  \\ 
   &  &  & Team Leader & P126448 & Zimbabwe Small Business Survey &  \\ 
  Saslavsky, Daniel Mario & Trade Specialist & WASHINGTON, DC & Team Member & P125104 & ZW:Trade \& Trans. Facilitation Zimbabwe &  \\ 
  \end{tabular}
}

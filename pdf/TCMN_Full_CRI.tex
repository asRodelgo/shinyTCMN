...
\begin{tabular}{l>{\raggedright}p{1in}ll>{\raggedright}p{1in}>{\raggedright}p{1in}rl}
 Project ID & Project Name & Approval Date & Status & Major Sector & Major Theme & Amount (in US\$ K) &  \\ 
  \hline
P147207 & CR Integration into Global Value Chains & 2015-02-14 & Closed & Industry and trade & Financial and private sector development & --- &  \\ 
  \end{tabular}
}
...
\begin{tabular}{>{\raggedright}p{1.4in}>{\raggedright}p{1in}>{\raggedright}p{1in}>{\raggedright}p{1in}l>{\raggedright}p{1.5in}l}
 Name & Job title & Location & Role & Project ID & Project name &  \\ 
  \hline
Heilbron, Armando & Senior Investment Promotion Officer & WASHINGTON, DC & Team Member & P147207 & CR Integration into Global Value Chains &  \\ 
  Kenyon, Thomas & Senior Private Sector Development Specialist & WASHINGTON, DC & Team Leader & P147207 & CR Integration into Global Value Chains &  \\ 
  \end{tabular}
}

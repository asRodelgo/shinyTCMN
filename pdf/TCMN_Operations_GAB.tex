...
\begin{tabular}{l>{\raggedright}p{1in}ll>{\raggedright}p{1in}>{\raggedright}p{1in}rl}
 Project ID & Project Name & Approval Date & Status & Major Sector & Major Theme & Amount (in US\$ K) &  \\ 
  \hline
P129267 & Investment Promotion and Competitiveness & 2014-03-11 & Active & Public Administration, Law, and Justice & Financial and private sector development & 2.e+04 &  \\ 
  \end{tabular}

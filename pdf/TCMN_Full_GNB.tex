...
\begin{tabular}{l>{\raggedright}p{1in}ll>{\raggedright}p{1in}>{\raggedright}p{1in}rl}
 Project ID & Project Name & Approval Date & Status & Major Sector & Major Theme & Amount (in US\$ K) &  \\ 
  \hline
P127209 & Priv Sec Rehab \& Agribusines Dev-PSRAD & 2014-05-22 & Active & Industry and trade & Rural development & 8,200 &  \\ 
  \end{tabular}
}
...
% latex table generated in R 3.2.2 by xtable 1.7-4 package
% Mon Jan 25 10:07:06 2016
{\footnotesize
\begin{tabular}{l>{\raggedright}p{1in}ll>{\raggedright}p{1in}>{\raggedright}p{1in}rl}
 Project ID & Project Name & Approval Date & Status & Major Sector & Major Theme & Amount (in US\$ K) &  \\ 
  \hline
P151400 & Investment Climate Policy Note & 2016-02-29 & Active & Industry and trade & Financial and private sector development & --- &  \\ 
  \end{tabular}
}
...
\begin{tabular}{>{\raggedright}p{1.4in}>{\raggedright}p{1in}>{\raggedright}p{1in}>{\raggedright}p{1in}l>{\raggedright}p{1.5in}l}
 Name & Job title & Location & Role & Project ID & Project name &  \\ 
  \hline
Campos, Francisco Moraes Leitao & Senior Economist & WASHINGTON, DC & Team Leader & P127209 & Priv Sec Rehab \& Agribusines Dev-PSRAD &  \\ 
   &  &  & Team Leader & P151400 & Investment Climate Policy Note &  \\ 
  Heilbron, Armando & Senior Investment Promotion Officer & WASHINGTON, DC & Extended-Team Member & P127209 & Priv Sec Rehab \& Agribusines Dev-PSRAD &  \\ 
  Hernandez Uriz, Zenaida & Senior Private Sector Development Specialist & WASHINGTON, DC & Team Member & P127209 & Priv Sec Rehab \& Agribusines Dev-PSRAD &  \\ 
   &  &  & Team Member & P151400 & Investment Climate Policy Note &  \\ 
  Iacovone, Leonardo & Senior Economist & MEXICO CITY, MEXICO & Team Member & P127209 & Priv Sec Rehab \& Agribusines Dev-PSRAD &  \\ 
  Ristic, Lazar & Operations Officer & BELGRADE, SERBIA & Extended-Team Member & P127209 & Priv Sec Rehab \& Agribusines Dev-PSRAD &  \\ 
  Solf, Sylvia & Senior Private Sector Development Specialist & WASHINGTON, DC & Team Member & P151400 & Investment Climate Policy Note &  \\ 
  \end{tabular}
}

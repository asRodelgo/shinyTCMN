...
\begin{tabular}{l>{\raggedright}p{1in}ll>{\raggedright}p{1in}>{\raggedright}p{1in}rl}
 Project ID & Project Name & Approval Date & Status & Major Sector & Major Theme & Amount (in US\$ K) &  \\ 
  \hline
P145971 & TZ Private Sector Comp. Project Addl Fin & 2013-12-27 & Active & Agriculture, fishing, and forestry & Urban development & 60,200 &  \\ 
  P150009 & TZ-Business Env \& Competitivenes fr Jobs & 2015-09-03 & Active & Industry and trade & Financial and private sector development & 80,000 &  \\ 
  \end{tabular}
}
...
\begin{tabular}{l>{\raggedright}p{1in}ll>{\raggedright}p{1in}>{\raggedright}p{1in}rl}
 Project ID & Project Name & Approval Date & Status & Major Sector & Major Theme & Amount (in US\$ K) &  \\ 
  \hline
P147012 & Local Content in the Oil and Gas Sector & 2016-03-15 & Active & Energy and mining & Financial and private sector development & --- &  \\ 
  \end{tabular}
}
...
\begin{tabular}{>{\raggedright}p{1.4in}>{\raggedright}p{1in}>{\raggedright}p{1in}>{\raggedright}p{1in}l>{\raggedright}p{1.5in}l}
 Name & Job title & Location & Role & Project ID & Project name &  \\ 
  \hline
Douw, Willem & Senior Operations Officer & VIENNA, AUSTRIA & Team Member & P150009 & TZ-Business Env \& Competitivenes fr Jobs &  \\ 
  Kibirige, Moses K. & Senior Private Sector Development Specialist & KAMPALA, UGANDA & Team Leader & P145971 & TZ Private Sector Comp. Project Addl Fin &  \\ 
   &  &  & Team Member & P150009 & TZ-Business Env \& Competitivenes fr Jobs &  \\ 
  Kojucharov, Nikola Denchev & Economist & WASHINGTON, DC & Team Member & P150009 & TZ-Business Env \& Competitivenes fr Jobs &  \\ 
  Marusic, Andreja & Senior Operations Officer & WASHINGTON, DC & Extended-Team Member & P145971 & TZ Private Sector Comp. Project Addl Fin &  \\ 
   &  &  & Team Member & P150009 & TZ-Business Env \& Competitivenes fr Jobs &  \\ 
  Racine, Jean-Louis Charles & Senior Private Sector Development Specialist & WASHINGTON, DC & Extended-Team Member & P147012 & Local Content in the Oil and Gas Sector &  \\ 
  Sichilima, Mupelwa & Operations Officer & NAIROBI, KENYA & Team Member & P150009 & TZ-Business Env \& Competitivenes fr Jobs &  \\ 
  \end{tabular}
}

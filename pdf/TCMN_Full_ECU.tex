...
\begin{tabular}{l>{\raggedright}p{1in}ll>{\raggedright}p{1in}>{\raggedright}p{1in}rl}
 Project ID & Project Name & Approval Date & Status & Major Sector & Major Theme & Amount (in US\$ K) &  \\ 
  \hline
P158277 & Ecuador Productivity TA & 2016-01-31 & Active & Finance & Financial and private sector development & --- &  \\ 
  P147359 & Ecuador: Services for Competitiveness & 2015-06-02 & Closed & Industry and trade & Financial and private sector development & --- &  \\ 
  P152807 & Ecuador Competitiveness RAS & 2015-11-20 & Closed & Industry and trade & Financial and private sector development & --- &  \\ 
  \end{tabular}
}
...
\begin{tabular}{>{\raggedright}p{1.4in}>{\raggedright}p{1in}>{\raggedright}p{1in}>{\raggedright}p{1in}l>{\raggedright}p{1.5in}l}
 Name & Job title & Location & Role & Project ID & Project name &  \\ 
  \hline
Dutz, Mark Andrew & Lead Economist & BRASILIA, BRAZIL & Extended-Team Member & P147359 & Ecuador: Services for Competitiveness &  \\ 
   &  &  & Team Member & P152807 & Ecuador Competitiveness RAS &  \\ 
  Franco-Temple, Ernesto & Operations Officer & LIMA, PERU & Team Member & P147359 & Ecuador: Services for Competitiveness &  \\ 
   &  &  & Extended-Team Member & P152807 & Ecuador Competitiveness RAS &  \\ 
  Kim, Maria Deborah & Private Sector Development Specialist & PORT-AU-PRINCE, HAITI & Extended-Team Member & P158277 & Ecuador Productivity TA &  \\ 
  Rubalcaba Bermejo, Luis & Senior Private Sector Development Specialist & WASHINGTON, DC & Team Leader & P147359 & Ecuador: Services for Competitiveness &  \\ 
   &  &  & Team Leader & P152807 & Ecuador Competitiveness RAS &  \\ 
  \end{tabular}
}

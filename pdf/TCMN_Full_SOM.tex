...
\begin{tabular}{l>{\raggedright}p{1in}ll>{\raggedright}p{1in}>{\raggedright}p{1in}rl}
 Project ID & Project Name & Approval Date & Status & Major Sector & Major Theme & Amount (in US\$ K) &  \\ 
  \hline
P152379 & Somalia Towage Services in Berbera Port & 2015-10-02 & Active & Transportation & Financial and private sector development &  4,900 &  \\ 
  P152241 & Somali Core Economic Institutions SCORE & 2016-01-20 & Pipeline & Industry and trade & Financial and private sector development & 28,500 &  \\ 
  \end{tabular}
}
...
\begin{tabular}{l>{\raggedright}p{1in}ll>{\raggedright}p{1in}>{\raggedright}p{1in}rl}
 Project ID & Project Name & Approval Date & Status & Major Sector & Major Theme & Amount (in US\$ K) &  \\ 
  \hline
P128557 & SO:Political Economy of PSD\&Job Creation & 2014-10-31 & Closed & Public Administration, Law, and Justice & Financial and private sector development & --- &  \\ 
  \end{tabular}
}
...
\begin{tabular}{l>{\raggedright}p{2.5in}llrl}
 Project ID & Project Name & Approval Date & Status & Amount (in US\$ K) &  \\ 
  \hline
600338 & Somalia Invesment Climate Reform Program & 2015-02-01 & Active & 1,132 &  \\ 
  \end{tabular}
}
...
\begin{tabular}{>{\raggedright}p{1.4in}>{\raggedright}p{1in}>{\raggedright}p{1in}>{\raggedright}p{1in}l>{\raggedright}p{1.5in}l}
 Name & Job title & Location & Role & Project ID & Project name &  \\ 
  \hline
Christow, Dobromir & Senior Private Sector Development Specialist & WASHINGTON, DC & Team Member & P152241 & Somali Core Economic Institutions SCORE &  \\ 
  Engman, Michael Olavi & Senior Economist & WASHINGTON, DC & Team Leader & P152241 & Somali Core Economic Institutions SCORE &  \\ 
   &  &  & Team Leader & P152379 & Somalia Towage Services in Berbera Port &  \\ 
  Fine, Gary J. & Senior Private Sector Development Specialist & WASHINGTON, DC & Team Member & P152241 & Somali Core Economic Institutions SCORE &  \\ 
  Hacibeyoglu, Cemile & Operations Officer & NAIROBI, KENYA & Extended-Team Member & 600338 & Somalia Invesment Climate Reform Program &  \\ 
  Hashi, Najeeb Hassan & Consultant & WASHINGTON, DC & Team Member & P128557 & SO:Political Economy of PSD\&Job Creation &  \\ 
   &  &  & Team Member & P152241 & Somali Core Economic Institutions SCORE &  \\ 
  Kilroy, Austin Francis Louis & Private Sector Development Specialist & WASHINGTON, DC & Team Member & P128557 & SO:Political Economy of PSD\&Job Creation &  \\ 
  Phillips, David A. & Consultant & WASHINGTON, DC & Team Member & P152241 & Somali Core Economic Institutions SCORE &  \\ 
  Zake, Fred & Senior Operations Officer & NAIROBI, KENYA & Extended-Team Member & 600338 & Somalia Invesment Climate Reform Program &  \\ 
   &  &  & Team Member & P152241 & Somali Core Economic Institutions SCORE &  \\ 
  \end{tabular}
}

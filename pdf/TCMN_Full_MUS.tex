...
\begin{tabular}{l>{\raggedright}p{1in}ll>{\raggedright}p{1in}>{\raggedright}p{1in}rl}
 Project ID & Project Name & Approval Date & Status & Major Sector & Major Theme & Amount (in US\$ K) &  \\ 
  \hline
P132367 & Improving Competitiveness NLTA & 2015-11-10 & Closed & Information and communications & Public sector governance & --- &  \\ 
  \end{tabular}
}
...
\begin{tabular}{>{\raggedright}p{1.4in}>{\raggedright}p{1in}>{\raggedright}p{1in}>{\raggedright}p{1in}l>{\raggedright}p{1.5in}l}
 Name & Job title & Location & Role & Project ID & Project name &  \\ 
  \hline
Dimitriyev, Steven R. & Senior Private Sector Development Specialist & MAPUTO, MOZAMBIQUE & Team Leader & P132367 & Improving Competitiveness NLTA &  \\ 
  Fine, Gary J. & Senior Private Sector Development Specialist & WASHINGTON, DC & Team Member & P132367 & Improving Competitiveness NLTA &  \\ 
  Hacibeyoglu, Cemile & Operations Officer & NAIROBI, KENYA & Team Member & P132367 & Improving Competitiveness NLTA &  \\ 
  Kuriakose, Smita & Senior Economist & WASHINGTON, DC & Team Leader & P132367 & Improving Competitiveness NLTA &  \\ 
  Marusic, Andreja & Senior Operations Officer & WASHINGTON, DC & Team Member & P132367 & Improving Competitiveness NLTA &  \\ 
  Zeng, Zhihua & Senior Economist & WASHINGTON, DC & Team Member & P132367 & Improving Competitiveness NLTA &  \\ 
  \end{tabular}
}
